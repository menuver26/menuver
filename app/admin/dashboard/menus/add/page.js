// app/admin/dashboard/menus/add/page.js
"use client";
        ...
        >
          <div className="lg:col-span-2 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label htmlFor="category" className="mb-1 block text-xs font-medium text-slate-600">Category</label>
                <select
                  id="category"
                  name="category"
                  required
                  className="w-full cursor-pointer rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800"
                >
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-slate-600">Menu Slug (hotelSlug)</label>
                <input
                  name="hotelSlug"
                  type="text"
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-slate-600">Hotel Slug (display)</label>
                <input
                  name="slug"
                  type="text"
                  required
              ...
              <div>
                ...
                <select name="top" className="w-full rounded-lg border px-3 py-2.5 text-sm">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="relative">
                <label className="group flex h-56 cursor-pointer items-center justify-center rounded-lg border-2 border-dashed bg-slate-50">
                  {imagePreview ? (
                    <Image width={300} height={240} src={imagePreview} alt="preview" className="h-full w-full object-cover" />
                  ) : (
          ...
          <div className="lg:col-span-3 flex justify-end gap-3">
            <button type="reset" className="rounded-lg border px-4 py-2" disabled={isSubmitting}>Reset</button>
            <button type="submit" className="rounded-lg bg-indigo-600 px-4 py-2 text-white" disabled={isSubmitting}>
